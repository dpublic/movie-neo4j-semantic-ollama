...
tools = [InformationTool(handle_tool_error=True), RecommenderTool(handle_tool_error=True), MemoryTool(handle_tool_error=True), SmalltalkTool(handle_tool_error=True)]
...
agent_executor = AgentExecutor(agent=agent, tools=tools, handle_parsing_errors=True).with_types(
